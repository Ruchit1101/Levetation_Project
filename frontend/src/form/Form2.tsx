...
//     setSelectFiles(selectedFilesArray);
//   }
// }
...
//                 <input
//                   type="file"
//                   className="w-full rounded-md border border-stroke p-3 outline-none transition file:mr-4 file:rounded file:border-[0.5px] file:border-stroke file:bg-[#EEEEEE] file:py-1 file:px-2.5 file:text-sm file:font-medium focus:border-primary file:focus:border-primary active:border-primary hover:cursor-pointer disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:file:border-strokedark dark:file:bg-black/30 dark:file:text-black"
//                  multiple onClick={handleFileUpload}
//                 />
//               </div>
//             </div>
//           </div>
...
//                     <span className="m-1.5 flex items-center justify-center rounded border-[.5px] border-stroke bg-gray py-1.5 px-2.5 text-sm font-medium dark:border-strokedark dark:bg-black/30">
//                       Design
