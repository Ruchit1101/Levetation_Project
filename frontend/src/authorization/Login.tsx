...
function Login(){
  ...
  return(
          ...
          <form onSubmit={handleClick}>
            ...
            <div className="mb-5">
              <input
                type="submit"
                value="Log In"
                className="w-full cursor-pointer rounded-lg border border-primary bg-blue-500 bg-primary p-4 text-white transition hover:bg-opacity-90"
              />
            </div>
    ...
    //             <Link to="/register" className="flex w-full justify-center rounded bg-blue-500 p-2 mt-3 font-medium text-white">Signup</Link>
    //           </div>
    //         </form>
